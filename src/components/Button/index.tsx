...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      }  text-center text-xl font-medium text-white bg-blue-600 rounded-sm disabled:opacity-80 gap-x-2 hover:bg-blue-700 shadow-E400 disabled:cursor-not-allowed`}
    >
